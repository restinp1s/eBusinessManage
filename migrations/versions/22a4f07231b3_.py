...
Revision ID: 22a4f07231b3
Revises: 18409f046c64
Create Date: 2026-09-12 04:42:22.964006
...
revision = '22a4f07231b3'
down_revision = '18409f046c64'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('ticket_title', sa.String(length=32), nullable=True),
    sa.Column('ticket_company', sa.String(length=32), nullable=True),
    sa.Column('ticket_content', sa.String(length=512), nullable=True),
    sa.Column('addrs', sa.String(length=128), nullable=True),
